...
class TestAccountPage:
    ...
    def test_go_to_account_from_header(self, driver, signin):
        ...
        current_url = accountpage.get_current_url()
    ...
    def test_user_logout(self, driver, signin):
        ...
        accountpage.wait_until_element_visibility(10, ResetPassPageLocators.ENTER_BUTTON)
        # Записываем в переменную текст элемента Войти на странице авторизации
        button_text = accountpage.get_element_text(ResetPassPageLocators.ENTER_BUTTON)
